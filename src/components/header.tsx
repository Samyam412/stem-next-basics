              ...
              <div className="rounded bg-white p-7 shadow-2xl sm:p-10">
                ...
                <form>
                  ...
                  <div className="mb-2 mt-4 sm:mb-4">
                    <button
                      type="submit"
                      className="bg-purple-400 hover:bg-purple-700 focus:shadow-outline inline-flex h-12 w-full items-center justify-center rounded px-6 font-medium tracking-wide text-white shadow-md transition duration-200 focus:outline-none"
                    >
                      Subscribe
                    </button>
                  </div>
